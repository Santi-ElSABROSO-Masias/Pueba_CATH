            ...
            html: `
                <div style="font-family: Arial, sans-serif; p-4; color: #333; max-width: 600px; margin: 0 auto;">
                    ...
                    <div style="background-color: #f8fafc; padding: 15px; border-radius: 8px; border: 1px solid #e2e8f0; margin: 20px 0;">
                        <p style="margin: 0 0 10px 0;"><strong>Enlace:</strong> <a href="${process.env.VITE_CAMPUS_URL || 'https://plataforma-catalina-campus-cath.c2awqr.easypanel.host'}/login">${process.env.VITE_CAMPUS_URL || 'https://plataforma-catalina-campus-cath.c2awqr.easypanel.host'}/login</a></p>
