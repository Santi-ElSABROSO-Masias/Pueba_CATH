      ...
      <div className="hidden md:block bg-white rounded-3xl border border-slate-200 shadow-lg overflow-hidden">
        ...
        <div className="grid grid-cols-7 auto-rows-[minmax(120px,_auto)] bg-slate-50 gap-px border-slate-200">
          ...
          {daysArray.map(day => {
            ...
            const dayTrainings = monthTrainings.filter(t => t.date === dateStr);
                  ...
                  {dayTrainings.map(t => (
                    ...
                    >
                      <div className="flex justify-between items-center">
                         <span className="truncate" style={{ color: t.color, fontWeight: 'bold' }}>{t.title}</span>
                      </div>
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex justify-between items-center mt-1">
                                        <span className="text-[10px] text-slate-500">{t.schedule}</span>
